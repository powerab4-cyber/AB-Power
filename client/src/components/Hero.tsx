      ...
      <div className="relative z-10 flex flex-1 flex-col justify-center pb-16 lg:pb-20">
        <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <div
              className="animate-fade-up mt-8 grid w-full grid-cols-2 gap-2 sm:flex sm:flex-wrap sm:justify-center sm:gap-3"
            ...
            >
              <a
                ...
                className="group flex items-center justify-center gap-2 rounded-full border border-white/10 bg-night/40 px-4 py-2.5 text-sm text-mist backdrop-blur transition-all duration-300 hover:border-pink-500/40 hover:bg-pink-500/10 hover:text-pink-400"
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-4 w-4 shrink-0 transition-transform group-hover:scale-110">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2 rounded-full border border-white/10 bg-night/40 px-4 py-2.5 text-sm text-mist backdrop-blur transition-all duration-300 hover:border-cyan-400/40 hover:bg-cyan-400/10 hover:text-cyan-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 transition-transform group-hover:scale-110">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2 rounded-full border border-white/10 bg-night/40 px-4 py-2.5 text-sm text-mist backdrop-blur transition-all duration-300 hover:border-blue-500/40 hover:bg-blue-500/10 hover:text-blue-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 transition-transform group-hover:scale-110">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="group flex items-center justify-center gap-2 rounded-full border border-white/10 bg-night/40 px-4 py-2.5 text-sm text-mist backdrop-blur transition-all duration-300 hover:border-green-500/40 hover:bg-green-500/10 hover:text-green-400"
              >
                <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 transition-transform group-hover:scale-110">
